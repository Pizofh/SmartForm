...
class PersonalData(models.Model):
    ...
    # --- Identity Documents ---
    document_type = models.CharField("Document type", max_length=2, choices=[("CI", "Citizen ID"), ("FI", "Foreigner ID")])
    ...
    street_type = models.CharField("Street type", max_length=20, null=True, choices=[
        ('Ring road', 'Ring road'), ('Highway', 'Highway'),
        ('Highway', 'Avenue'), ('Avenue Street', 'Avenue Street'),
        ('Avenue Road', 'Avenue Road'), ('Street', 'Street'),
...
class FamilyData(models.Model):
    ...
    spouse_phone = models.IntegerField("Spouse's Mobile", blank=True,null=True, validators=[MinValueValidator(1_000), MaxValueValidator(999_999_999_999)])
...
class Sibling(models.Model):
    ...
    sibling_street_type = models.CharField("Street type", max_length=20, null=True, blank=True, choices=[
        ('Ring road', 'Ring road'), ('Highway', 'Highway'), ('Avenue', 'Avenue'),
        ('Avenue Street', 'Avenue Street'), ('Avenue Avenue', 'Avenue Avenue'), ('Street', 'Street'),
        ('Alley', 'Alley'), ('Avenue', 'Avenue'), ('Circle', 'Circle'),
        ('Diagonal', 'Diagonal'), ('Cross street', 'Cross street')
    ])
...
class DocumentoGenerado(models.Model):
    PersonalData = models.ForeignKey(PersonalData, on_delete=models.CASCADE, related_name="documentos",default=1)
